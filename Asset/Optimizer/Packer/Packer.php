...
use Bundle\AssetOptimizerBundle\Asset\Optimizer\Packer\ParseMaster;
...
class Packer {
  ...
  'function($charCode) {
     ...
     *
     * Enter description here ...
     * @param unknown_type $match1
     * @param unknown_type $match2
     */
    ...
    */
    ...
    {
      return preg_replace_callback('/[\\xa1-\\xff]/', array(&$this, '_escape95Bis'), $script);
    }
